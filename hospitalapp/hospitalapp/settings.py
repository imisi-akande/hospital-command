...
SECRET_KEY = 'i@a6z4oi@(ic6#x7%7mv08-wc_fd#3pp(-5)boqw&^qt61qq8t'
...
COVERAGE_EXCLUDE_MODULES = (
    'hospitalapp.migrations',
    'hospitalapp.tests',
    'hospitalapp.local_settings',
    'opal.migrations',
    'opal.tests',
    'opal.wsgi',
)
...
DEFAULT_DOMAIN = 'http://hospitalapp.com/'


# ========== PROJECT ==========
OPAL_BRAND_NAME = 'hospitalapp'
